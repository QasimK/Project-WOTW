...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemAction.allow_fight_target'
        db.delete_column(u'game_itemaction', 'allow_fight_target')

        # Deleting field 'ItemAction.allow_char_target'
        db.delete_column(u'game_itemaction', 'allow_char_target')

        # Adding field 'ItemAction.target'
        db.add_column(u'game_itemaction', 'target',
                      self.gf('django.db.models.fields.CharField')(default='c', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ItemAction.allow_fight_target'
        db.add_column(u'game_itemaction', 'allow_fight_target',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ItemAction.allow_char_target'
        db.add_column(u'game_itemaction', 'allow_char_target',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ItemAction.target'
        db.delete_column(u'game_itemaction', 'target')
