...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemAction.name'
        db.delete_column(u'game_itemaction', 'name')

        # Adding unique constraint on 'ItemAction', fields ['func']
        db.create_unique(u'game_itemaction', ['func'])


    def backwards(self, orm):
        # Removing unique constraint on 'ItemAction', fields ['func']
        db.delete_unique(u'game_itemaction', ['func'])

        # Adding field 'ItemAction.name'
        db.add_column(u'game_itemaction', 'name',
