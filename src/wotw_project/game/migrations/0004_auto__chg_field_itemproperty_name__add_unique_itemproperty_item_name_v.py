...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemProperty.name'
        db.alter_column(u'game_itemproperty', 'name', self.gf('django.db.models.fields.CharField')(max_length=3))
        # Adding unique constraint on 'ItemProperty', fields ['item', 'name', 'value']
        db.create_unique(u'game_itemproperty', ['item_id', 'name', 'value'])


    def backwards(self, orm):
        # Removing unique constraint on 'ItemProperty', fields ['item', 'name', 'value']
        db.delete_unique(u'game_itemproperty', ['item_id', 'name', 'value'])


        # Changing field 'ItemProperty.name'
        db.alter_column(u'game_itemproperty', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
