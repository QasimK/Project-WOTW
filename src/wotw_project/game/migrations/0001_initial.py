...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_character', (
            ...
            ('weapon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='character_weapon', to=orm['game.Item'])),
            ('armour', self.gf('django.db.models.fields.related.ForeignKey')(related_name='character_armour', to=orm['game.Item'])),
        ...
        db.create_table(u'game_monster', (
            ...
            ('gold', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('gold_dev', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'game.monster': {
            ...
            'gold': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'gold_dev': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'hp': ('django.db.models.fields.IntegerField', [], {}),
