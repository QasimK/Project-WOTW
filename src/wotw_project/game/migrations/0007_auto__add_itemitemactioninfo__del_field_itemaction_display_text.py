...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemItemActionInfo'
        db.create_table(u'game_itemitemactioninfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Item'])),
            ('item_action', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.ItemAction'])),
            ('display_text', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'game', ['ItemItemActionInfo'])

        # Deleting field 'ItemAction.display_text'
        db.delete_column(u'game_itemaction', 'display_text')
    ...
    def backwards(self, orm):
        # Deleting model 'ItemItemActionInfo'
        db.delete_table(u'game_itemitemactioninfo')

        # Adding field 'ItemAction.display_text'
        db.add_column(u'game_itemaction', 'display_text',
