...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveMonster.soulbound'
        db.add_column(u'game_activemonster', 'soulbound',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveMonster.soulbound'
        db.delete_column(u'game_activemonster', 'soulbound')
