...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_itemaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('display_text', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('func', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('allow_char_target', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_fight_target', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_in_combat', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_out_combat', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'game', ['ItemAction'])

        # Adding M2M table for field item_actions on 'Item'
        m2m_table_name = db.shorten_name(u'game_item_item_actions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'game.item'], null=False)),
            ('itemaction', models.ForeignKey(orm[u'game.itemaction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'itemaction_id'])


    def backwards(self, orm):
        # Deleting model 'ItemAction'
        db.delete_table(u'game_itemaction')

        # Removing M2M table for field item_actions on 'Item'
        db.delete_table(db.shorten_name(u'game_item_item_actions'))
    ...
    models = {
        ...
        u'game.item': {
            ...
            'item_actions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['game.ItemAction']", 'symmetrical': 'False'}),
            'max_stack_size': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        },
        u'game.itemaction': {
            'Meta': {'object_name': 'ItemAction'},
            'allow_char_target': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'allow_fight_target': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'func': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        },
        u'game.itemproperty': {
