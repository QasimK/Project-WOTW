...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Character.armour'
        db.alter_column(u'game_character', 'armour_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['game.Item']))

        # Changing field 'Character.weapon'
        db.alter_column(u'game_character', 'weapon_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['game.Item']))

    def backwards(self, orm):

        # Changing field 'Character.armour'
        db.alter_column(u'game_character', 'armour_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['game.Item']))

        # Changing field 'Character.weapon'
        db.alter_column(u'game_character', 'weapon_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['game.Item']))
